# Generated by Powerlevel10k configuration wizard on 2021-12-30 at 12:43 -03.
...
() {
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=0 # 0
  typeset -g POWERLEVEL9K_TASKWARRIOR_BACKGROUND=40 # 6
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=254 # 1
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=1 # 0
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=254 # 3
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=3 # 0
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=254 # 3
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=024 # 0
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=13 # 1
